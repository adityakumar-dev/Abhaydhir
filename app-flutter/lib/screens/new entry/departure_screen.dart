...
class DepartureScreen extends StatefulWidget {
  static const String routeName = '/departure';
...
class _DepartureScreenState extends State<DepartureScreen> {
  ...
  Future<void> _onDetect(BarcodeCapture capture) async {
    ...
    try {
      ...
      _showLoadingDialog(context, 'Registering departure...');

      // Register departure using ServerApi with loaded event info
      final result = await ServerApi.registerDeparture(
        userId: userId,
      ...
      if (result != null && result['message'] != null) {
        ...
        // Exit departure screen
        Navigator.of(context).pop();
      } else {
        throw Exception('Failed to register departure');
      }
    } catch (e) {
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const Text(
                    'Scan QR code to register departure',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
