...
class InvitationEmailHandler:
    ...
    def send_welcome_email(
        ...
        try:
            ...
            msg["From"] = self.email
            msg["To"] = to_email
            msg["Subject"] = f"Welcome to Spring Festival - Your Visitor Card is Ready"
            ...
            # Attach Visitor Card
            if visitor_card_path and os.path.exists(visitor_card_path):
...
def send_welcome_email_background(
    ...
    def send_email():
        try:
            ...
            if success:
                print(f"✅ Background email sent successfully to {user_email}")
            else:
