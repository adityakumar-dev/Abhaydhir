...
export default function RegisterPage({ params }: { params: { event_id: string } }) {
  ...
  // ── File picker refs (camera vs gallery) ─────────────────────────────────
  const photoGalleryRef = useRef<HTMLInputElement>(null);
  const photoCameraRef  = useRef<HTMLInputElement>(null);
  const idGalleryRef    = useRef<HTMLInputElement>(null);
  const idCameraRef     = useRef<HTMLInputElement>(null);
  /** Which field's source-chooser is currently open */
  const [showPicker, setShowPicker] = useState<null | "photo" | "id">(null);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() => setShowPicker(showPicker === "photo" ? null : "photo")}
                  className="flex items-center justify-center w-full h-48 rounded-lg border-2 border-dashed border-yellow-300 bg-yellow-50 hover:bg-yellow-100 transition-all overflow-hidden relative"
                >
                  {formData.photo ? (
                    <>
                      <img
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm font-semibold text-yellow-900">Tap to add photo</p>
                ...
                {/* Source chooser */}
                {showPicker === "photo" && (
                  <div className="absolute z-20 left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                    <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                      <span className="text-sm font-semibold text-gray-700">Choose source</span>
                      <button type="button" onClick={() => setShowPicker(null)} className="text-gray-400 hover:text-gray-600">
                        <X className="w-4 h-4" />
                      </button>
                    </div>
                    <div className="grid grid-cols-2 divide-x divide-gray-100">
                      <button
                        type="button"
                        className="flex flex-col items-center gap-2 py-5 hover:bg-yellow-50 transition-colors"
                        onClick={() => { photoCameraRef.current?.click(); setShowPicker(null); }}
                      >
                      ...
                      <button
                        type="button"
                        className="flex flex-col items-center gap-2 py-5 hover:bg-yellow-50 transition-colors"
                        onClick={() => { photoGalleryRef.current?.click(); setShowPicker(null); }}
                      >
                        <ImageIcon className="w-7 h-7 text-yellow-600" />
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() => setShowPicker(showPicker === "id" ? null : "id")}
                  className="flex items-center justify-center w-full h-48 rounded-lg border-2 border-dashed border-orange-300 bg-orange-50 hover:bg-orange-100 transition-all overflow-hidden relative"
                >
                  {formData.unique_id_photo ? (
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm font-semibold text-orange-900">Tap to add ID photo</p>
                ...
                {showPicker === "id" && (
                  <div className="absolute z-20 left-0 right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-xl overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 divide-x divide-gray-100">
                      <button
                        type="button"
                        className="flex flex-col items-center gap-2 py-5 hover:bg-orange-50 transition-colors"
                        onClick={() => { idCameraRef.current?.click(); setShowPicker(null); }}
                      >
                      ...
                      <button
                        type="button"
                        className="flex flex-col items-center gap-2 py-5 hover:bg-orange-50 transition-colors"
                        onClick={() => { idGalleryRef.current?.click(); setShowPicker(null); }}
                      >
